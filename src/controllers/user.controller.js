...
const getUser = catchAsync(async (req, res) => {
  ...
  if (queryParam === 'address') {
    const userData = await userService.getUserAddressById(userId);
    ...
    res.status(httpStatus.OK).send({"address" :userData.address});
  } else {
...
const createUser  = catchAsync(async (req, res) => {
  ...
  if(!data){
    throw new ApiError(httpStatus.INTERNAL_SERVER_ERROR,"User is Not created");
  }
